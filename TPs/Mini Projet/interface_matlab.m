...
% Last Modified by GUIDE v2.5 02-Feb-2024 23:57:56
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% Supposons que I4 soit votre image
I4 = handles.courant_data;

% Définir un seuil aléatoire entre 0 et 255
seuil_aleatoire = 128;

% Binariser l'image en utilisant le seuil aléatoire
image_binarisee = (I4 < seuil_aleatoire) * 0 + (I4 >= seuil_aleatoire) * 255;
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% Supposons que ima soit votre image d'origine
...
% Appliquer la transformation selon la formule que vous avez donnée
imagray_transformed = (255/(max_val - min_val)) * (imagray - min_val);
% Afficher l'image transformée
axes(handles.axes2);
imshow(uint8(imagray_transformed));  % Assurez-vous que les valeurs sont dans la plage [0, 255]
...
% --------------------------------------------------------------------
function detection_cercles_Callback(hObject, eventdata, handles)
